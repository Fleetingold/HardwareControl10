...
{
    public class ZY2000Section2: SectionBase
    {
        #region 构造函数
        public ZY2000Section2(object driver, IPassword pass) :base(2,driver)
        {
            Block0 = new ZY2000Block20(driver);
            Block0.PropertyChanged += Block_PropertyChanged;
            Block1 = new ZY2000Block21(driver);
            Block1.PropertyChanged += Block_PropertyChanged;
            Block2 = new ZY2000Block22(driver);
        ...
        #region 属性成员
        public ZY2000Block20 Block0
        {
            get
            {
                return GetValue<ZY2000Block20>("Block0");
            }
            set
            {
                SetValue<ZY2000Block20>("Block0", value);
            }
        }

        public ZY2000Block21 Block1
        {
            get
            {
                return GetValue<ZY2000Block21>("Block1");
            }
            set
            {
                SetValue<ZY2000Block21>("Block1", value);
            }
        }

        public ZY2000Block22 Block2
        {
            get
            {
                return GetValue<ZY2000Block22>("Block2");
            }
            set
            {
                SetValue<ZY2000Block22>("Block2", value);
            }
        }
